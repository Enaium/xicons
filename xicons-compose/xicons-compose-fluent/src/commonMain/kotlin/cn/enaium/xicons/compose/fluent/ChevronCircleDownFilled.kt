...
public val FluentIcons.Filled.ChevronCircleDown: ImageVector
    get() {
        ...
        _ChevronCircleDown = ImageVector.Builder(
            ...
            path(fill = SolidColor(androidx.compose.ui.graphics.Color.Black)) {
                ...
                close()
                moveTo(7.47f, 9.97f)
                arcTo(0.75f, 0.75f, 0.00f, false, false, 7.47f, 11.03f)
                lineTo(11.47f, 15.03f)
                arcTo(0.75f, 0.75f, 0.00f, false, false, 12.53f, 15.03f)
                lineTo(16.53f, 11.03f)
                arcTo(0.75f, 0.75f, 0.00f, true, false, 15.47f, 9.97f)
                lineTo(12.00f, 13.44f)
                lineTo(8.53f, 9.97f)
                arcTo(0.75f, 0.75f, 0.00f, false, false, 7.47f, 9.97f)
                close()
            }
        }.build()
        return _ChevronCircleDown!!
