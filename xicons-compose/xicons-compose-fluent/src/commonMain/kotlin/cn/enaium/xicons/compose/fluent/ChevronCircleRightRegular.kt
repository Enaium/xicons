    ...
    get() {
        ...
        _ChevronCircleRight = ImageVector.Builder(
            ...
            path(fill = SolidColor(androidx.compose.ui.graphics.Color.Black)) {
                ...
                close()
                moveTo(9.97f, 16.53f)
                arcTo(0.75f, 0.75f, 0.00f, false, true, 9.97f, 15.47f)
                lineTo(13.44f, 12.00f)
                lineTo(9.97f, 8.53f)
                arcTo(0.75f, 0.75f, 0.00f, false, true, 11.03f, 7.47f)
                lineTo(15.03f, 11.47f)
                arcTo(0.75f, 0.75f, 0.00f, false, true, 15.03f, 12.53f)
                lineTo(11.03f, 16.53f)
                arcTo(0.75f, 0.75f, 0.00f, false, true, 9.97f, 16.53f)
                close()
            }
        }.build()
        return _ChevronCircleRight!!
